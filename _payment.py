...
class Payment(Moyasar):
    ...
    @staticmethod
    def create_payment(arguments, my_key):
        try:
    ...
    def refund_payment(self, arguments, my_key):
        try:
    ...
    def update_payment(self,arguments, my_key):
        try:
